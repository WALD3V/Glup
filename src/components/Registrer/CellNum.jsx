...
export default function CellNum() {
    ...
    return (
        <Datareg
            onLayout={onLayout}
            textTitle="Ingresa tu numero celular"
            textcoment="* Tu numero Principal"
            inputComponent={
                <ImputNumber
            ...
            inputbutton={inputText.length > 2 && ( // Cambia 10 por la longitud máxima que deseas
                <OptionsAdd text={'Recibir codigo por sms'} navigate={'Code'} />
            )}
        />
    );
};
